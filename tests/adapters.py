...
def run_linear(
    ...
    return llModel.LLModel.run_linear(d_in,d_out,weights,in_features)
...
def run_silu(in_features: Float[Tensor, " ..."]) -> Float[Tensor, " ..."]:
    ...
    return trainTools.run_silu(in_features)
    #def sigmoid(x):
...
def run_get_batch(
    ...
    """
    return trainTools.get_batch(dataset,batch_size,context_length,device)
...
def run_softmax(in_features: Float[Tensor, " ..."], dim: int) -> Float[Tensor, " ..."]:
    ...
    #print('new softmax')
    #import pdb; pdb.set_trace()
    return trainTools.run_softmax(in_features,dim)
...
def run_cross_entropy(inputs: Float[Tensor, " batch_size vocab_size"], targets: Int[Tensor, " batch_size"]) -> Float[Tensor, ""]:
    ...
    #import pdb; pdb.set_trace()
    return trainTools.run_cross_entropy(inputs,targets)
...
def run_gradient_clipping(parameters: Iterable[torch.nn.Parameter], max_l2_norm: float) -> None:
    ...
    trainTools.run_gradient_clipping(parameters,max_l2_norm)
...
def run_get_lr_cosine_schedule(
    ...
    return trainTools.get_lr_cosine_schedule(it,max_learning_rate,min_learning_rate,
...
def run_save_checkpoint(
    ...
    trainTools.save_checkpoint(model,optimizer,iteration,out)
...
def run_load_checkpoint(
    ...
    return trainTools.load_checkpoint(src,model,optimizer)
